...
ALTER TABLE `transaksi`
  ...
  ADD KEY `transaksi_id_dt_katalog_foreign` (`id_dt_katalog`);
...
--
ALTER TABLE `detailPJ`
  MODIFY `id_detailPJ` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=233;

--
-- AUTO_INCREMENT for table `dt_katalog`
--
ALTER TABLE `dt_katalog`
  MODIFY `id_dt_katalog` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1032;

--
-- AUTO_INCREMENT for table `dt_transaksi`
--
ALTER TABLE `dt_transaksi`
  MODIFY `id_dt_transaksi` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=676;

--
-- AUTO_INCREMENT for table `katalog`
--
ALTER TABLE `katalog`
  MODIFY `id_katalog` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=350;
...
--
ALTER TABLE `pengguna`
  MODIFY `id_user` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1018;
...
--
ALTER TABLE `transaksi`
  MODIFY `id_transaksi` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=565;
...
--
ALTER TABLE `transaksi`
  ADD CONSTRAINT `transaksi_id_dt_katalog_foreign` FOREIGN KEY (`id_dt_katalog`) REFERENCES `dt_katalog` (`id_dt_katalog`),
