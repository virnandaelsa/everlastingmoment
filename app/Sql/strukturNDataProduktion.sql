...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 30, 2024 at 10:25 AM
...
--
-- Table structure for table `detailPJ`
--

CREATE TABLE `detailPJ` (
  `id_detailPJ` bigint(20) UNSIGNED NOT NULL,
  ...
  `profil_tk` varchar(255) DEFAULT NULL,
  `sampul_tk` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `dt_katalog`
--

CREATE TABLE `dt_katalog` (
  `id_dt_katalog` bigint(20) UNSIGNED NOT NULL,
  `judul_variasi` varchar(255) NOT NULL,
...
CREATE TABLE `dt_transaksi` (
  `id_dt_transaksi` bigint(20) UNSIGNED NOT NULL,
  `id_transaksi` bigint(20) UNSIGNED NOT NULL,
  `ket` varchar(255) NOT NULL,
  `bukti_tfDP` varchar(255) NOT NULL,
  `bukti_tfPelunasan` varchar(255) NOT NULL,
...
(4, '2024_06_18_000003_kategori', 1),
(5, '2024_06_19_000003_detailPJ', 1),
(6, '2024_06_19_000005_katalog', 1),
(7, '2024_06_19_000006_dt_katalog', 1),
(8, '2024_06_19_000007_transaksi', 1),
(9, '2024_06_19_000008_dt_transaksi', 1),
(10, '2024_06_19_000009_review', 1);
...
CREATE TABLE `review` (
  ...
  `deskripsi_kualitas` varchar(255) DEFAULT NULL,
  `deskripsi_ketepatan` varchar(255) DEFAULT NULL,
  `deskripsi_pelayanan` varchar(255) DEFAULT NULL,
  `ft_review` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indexes for table `detailPJ`
--
ALTER TABLE `detailPJ`
  ADD PRIMARY KEY (`id_detailPJ`),
  ADD UNIQUE KEY `detailpj_no_rek_unique` (`no_rek`),
  ADD KEY `detailpj_id_user_foreign` (`id_user`);

--
-- Indexes for table `dt_katalog`
--
ALTER TABLE `dt_katalog`
  ADD PRIMARY KEY (`id_dt_katalog`),
  ADD KEY `dt_katalog_id_katalog_foreign` (`id_katalog`);
...
ALTER TABLE `dt_transaksi`
  ...
  ADD KEY `dt_transaksi_id_transaksi_foreign` (`id_transaksi`);
...
ALTER TABLE `katalog`
  ...
  ADD KEY `katalog_id_detailpj_foreign` (`id_detailPJ`);
...
ALTER TABLE `pengguna`
  ...
  ADD UNIQUE KEY `pengguna_no_telp_unique` (`no_telp`),
...
ALTER TABLE `review`
  ...
  ADD KEY `review_id_transaksi_foreign` (`id_transaksi`);
...
ALTER TABLE `transaksi`
  ...
  ADD KEY `transaksi_id_katalog_foreign` (`id_katalog`);
...
--
-- AUTO_INCREMENT for table `detailPJ`
--
ALTER TABLE `detailPJ`
  MODIFY `id_detailPJ` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=232;

--
-- AUTO_INCREMENT for table `dt_katalog`
--
ALTER TABLE `dt_katalog`
  MODIFY `id_dt_katalog` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1029;

--
-- AUTO_INCREMENT for table `dt_transaksi`
--
ALTER TABLE `dt_transaksi`
  MODIFY `id_dt_transaksi` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=667;

--
-- AUTO_INCREMENT for table `katalog`
--
ALTER TABLE `katalog`
  MODIFY `id_katalog` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=347;
...
--
ALTER TABLE `pengguna`
  MODIFY `id_user` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1015;

--
-- AUTO_INCREMENT for table `review`
--
ALTER TABLE `review`
  MODIFY `id_review` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=445;

--
-- AUTO_INCREMENT for table `transaksi`
--
ALTER TABLE `transaksi`
  MODIFY `id_transaksi` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=556;
...
--
-- Constraints for table `detailPJ`
--
ALTER TABLE `detailPJ`
  ADD CONSTRAINT `detailpj_id_user_foreign` FOREIGN KEY (`id_user`) REFERENCES `pengguna` (`id_user`);

--
-- Constraints for table `dt_katalog`
--
ALTER TABLE `dt_katalog`
  ADD CONSTRAINT `dt_katalog_id_katalog_foreign` FOREIGN KEY (`id_katalog`) REFERENCES `katalog` (`id_katalog`);

--
-- Constraints for table `dt_transaksi`
--
ALTER TABLE `dt_transaksi`
  ADD CONSTRAINT `dt_transaksi_id_transaksi_foreign` FOREIGN KEY (`id_transaksi`) REFERENCES `transaksi` (`id_transaksi`);

--
-- Constraints for table `katalog`
--
ALTER TABLE `katalog`
  ADD CONSTRAINT `katalog_id_detailpj_foreign` FOREIGN KEY (`id_detailPJ`) REFERENCES `detailPJ` (`id_detailPJ`);

--
-- Constraints for table `review`
--
ALTER TABLE `review`
  ADD CONSTRAINT `review_id_transaksi_foreign` FOREIGN KEY (`id_transaksi`) REFERENCES `transaksi` (`id_transaksi`);

--
-- Constraints for table `transaksi`
--
ALTER TABLE `transaksi`
  ADD CONSTRAINT `transaksi_id_katalog_foreign` FOREIGN KEY (`id_katalog`) REFERENCES `katalog` (`id_katalog`),
  ADD CONSTRAINT `transaksi_id_user_foreign` FOREIGN KEY (`id_user`) REFERENCES `pengguna` (`id_user`);
COMMIT;
